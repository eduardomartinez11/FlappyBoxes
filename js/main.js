...
var mainState = {
  ...
  create: function () {
    ...
    //Now that we have a bird and gravity...we beed to tell the bird
    ...
    this.labelScore = game.add.text(20,20, "0", {font: "30px Arial", fil: "#ffffff"});
  ...
  update: function () {
    ...
    //Check if the bird is outside of the game screen
